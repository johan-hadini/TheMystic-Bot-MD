...
if (!args[0]) throw '*[❗ملاحظه❗] ادخل الامر وجنبه رابط الفيديو اليوتيوب الذي تريد تحميله*'
await m.reply(`*_⏳سيتم ارسال المقطع يرجى الانتظار لحظه  ◉*`)
try {
let qu = args[1] || '480'
let q = qu + 'p'
let v = args[0]
